            ...
            try
            {
                ...
                switch (command)
                {
                    ...
                    case "/gettesterrors":
                    {
                        ...
                        break;
                    case "/downloaddiagnosticdata":
                        {
                            CltOperations.DownloadDiagnosticData(args[1]);
                        }
                        break;
                    case "/?":
                        ShowCommandlineHelp();
